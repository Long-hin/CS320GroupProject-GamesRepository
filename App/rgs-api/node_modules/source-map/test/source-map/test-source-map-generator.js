...
define(function (require, exports, module) {
  ...
  var SourceMapGenerator = require('source-map/lib/source-map/source-map-generator').SourceMapGenerator;
  var SourceMapConsumer = require('source-map/lib/source-map/source-map-consumer').SourceMapConsumer;
  var SourceNode = require('source-map/lib/source-map/source-node').SourceNode;
  var util = require('source-map/test/source-map/util');
